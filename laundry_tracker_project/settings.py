...
DEBUG = True
ALLOWED_HOSTS = ['django-loundary-tracker-project.onrender.com', '127.0.0.1', 'localhost']
CSRF_TRUSTED_ORIGINS = ['django-loundary-tracker-project.onrender.com', '127.0.0.1', 'localhost']
